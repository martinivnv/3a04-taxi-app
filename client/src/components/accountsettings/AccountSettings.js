...
<h1 >Settings</h1>
  ...
  <form onSubmit={handleSubmit}
    ...
    <button type="submit" style={{ fontSize: "1em" }}>Change Password </button>
  </form>
  ...
  <h4 align="left"  >Delete Account</h4>
        <label>Warning: Deleting your account will permanently delete your account and cannot be undone. Are you sure you want to proceed?</label>
        <p>
        <button type="submit" onClick={confirmDelete} style={{ fontSize: "1em" }}>
					Delete Account
		</button> 
        </p>
